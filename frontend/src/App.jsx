...
const AssetHubDashboardWithSidebar = lazy(() => import("./pages/AssetHub/AssetHubDashboardWithSidebar"));
const SolidityGenerator = lazy(() => import("./pages/SolidityGenerator/SolidityGenerator"));
const MockXcmTrigger = lazy(() => import("./MockXCMTrigger"));
const ContractDeployer = lazy(() => import("./pages/CompileAndDeploy/CompileAndDeploy"));
const MonitoringWithDashboard = lazy(() => import("./pages/AssetHub/MonitoringWithDashboard"));
