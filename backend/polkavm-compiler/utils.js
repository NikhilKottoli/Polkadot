...
export async function pollForEvents(contractAddress, abi, contractName, fromBlock = 'latest') {
    try {
 ...
 export function setupEventMonitoring(contractAddress, abi, contractName = 'Unknown') {
    try {
